...
function NavbarTop() {
  return (
    <div id='navbartop-container' className=''> 
      <nav id='navbartop' className='flex items-center p-5 text-white absolute w-full bg-linear-to-b from-black to-transparent'>
